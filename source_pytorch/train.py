...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_features', type=int, default=3, metavar='N',
                        help='number of features that are used to train the model (default: 3)')
    parser.add_argument('--hidden_dim', type=int, default=15, metavar='N',
                        help='number of nodes that are present in the hidden layer (default: 15)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='N',
                        help='number of nodes that are present in the output layer (default: 1)')
